...
for i in range(5, 51, 5):
    ...
    if i < 10:
        str_i = '0' + str(i)
    fn = output_folder + 'iteration_grid_size_' + str_i + '.json'
...
for i in range(5, 51, 5):
    ...
    if i < 10:
        str_i = '0' + str(i)
    fn = output_folder + 'iteration_grid_size_' + str_i + '_relaxed.json'
    if fn in os.listdir(output_folder):
        with open(fn, 'r') as file:
            data = json.load(file)
...
yAxisRel = []
for i in range(10, 51, 5):
    fn = output_folder + 'iteration_pi_length_' + str(i) + '_relaxed.json'
    if fn in os.listdir(output_folder):
        with open(fn, 'r') as file:
            data = json.load(file)
            yAxisRel.append(data['solution_additional_info']['execution_time'])
...
for i in range(10, 1251, 125):
    fn = output_folder + 'iteration_n_obstacles_' + str(i) + '.json'
    if fn in os.listdir(output_folder):
        xAxis.append(i)
        with open(fn, 'r') as file:
            data = json.load(file)
...
yAxisRel = []
for i in range(10, 1251, 125):
    fn = output_folder + 'iteration_n_obstacles_' + str(i) + '_relaxed.json'
    if fn in os.listdir(output_folder):
        with open(fn, 'r') as file:
            data = json.load(file)
            yAxisRel.append(data['solution_additional_info']['execution_time'])
